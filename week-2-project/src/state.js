...
// When English is displayed, the button must say "Translation to japanese please"
...
const Ex6 = function () {
  ...
  const [prevFib, setPrevFib] = useState(0);
    ...
    <div>
      ...
      <button
        onClick={() => {
          ...
          //console.log("PrevFib is: " + prevFib);
        }}
      >
        Click me!
      </button>
...
const Ex8 = function () {
  ...
  const tag = ["fruit", "meat", "vegetables"];
  const [idx, setIdx] = useState(0);
  return (
    <div>
      <p>I like {tag[idx]}</p>
